...
- 打开编辑器准备写代码，十分钟后发现自己在刷 B 站
- 等 AI 回答的间隙，随手打开了知乎，半小时后才想起来切回去
- 同时开着十几个窗口，注意力总被不相关的那个吸走

那 Sprout 可能是给你做的。它尤其适合：

- **ADHD 或注意力难以集中的人** — 靠意志力抵抗分心很累，不如让程序来守
- **多任务工作者** — 在家办公、独立开发、边写论文边查资料的学生
- **对自己的自制力不自信的人** — 知道该做什么，但就是容易飘
...
2. **网费很贵 / BlockSites**（浏览器插件）——同样有效，能限制我在知乎、B 站、小红书的停留，但终究只管浏览器里面。
